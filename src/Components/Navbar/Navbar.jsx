...
import './Navbar.css'
import logo from '/src/assets/tayyabLogo.svg'
    ...
    <div className='navbar'>
        ...
        <ul ref={menuRef} className="nav-menu">
          <img src={menu_close} onClick={closeMenu} alt="" className="nav-mob-close" />
            ...
            <li><AnchorLink className='anchor-link' offset={50} href='#contact'><p onClick={()=>setMenu("contact")}>Contacts</p></AnchorLink>{menu==="contact"?<img src={nav_underline} alt=''/>:<></>}</li>
        </ul>
